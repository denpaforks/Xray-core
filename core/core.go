...
var (
	build    = "Custom"
	codename = "Caddy"
	intro    = "Fast and extensible multi-platform HTTP/1-2-3 web server with automatic HTTPS."
)
...
func VersionStatement() []string {
	return []string{
		serial.Concat("Caddy ", Version(), " (", codename, ") ", build, " (", runtime.Version(), " ", runtime.GOOS, "/", runtime.GOARCH, ")"),
		intro,
	}
}
