...
var (
	...
	certCommonName   = cmdCert.Flag.String("name", "Caddy Inc", "The common name of this certificate")
	certOrganization = cmdCert.Flag.String("org", "Caddy Inc", "Organization of the certificate")
